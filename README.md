...
# Content #
This folder contains the first release of the Italy EnergyScope model.  
More recent releases are available @ the EnergyScope project repository: https://github.com/energyscope/EnergyScope/tree/EnergyScopeIT   
...
[4] M. Borasio and S. Moret (2021). Deep decarbonisation of regional energy systems: a novel modelling approach and its application to the Italian energy transition. To appear in Renewable & Sustainable Energy Reviews. 