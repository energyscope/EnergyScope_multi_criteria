...
if __name__ == '__main__':
    ...
    plot_two_series(df_data_1=df_cost_einv.sum(axis=1), df_data_2=df_cost_cost.sum(axis=1), label_1=label1, label_2=label2, pdf_name=dir_plot+'/cost-vs-eroi_cost_'+ str(domestic_RE_share)+'.pdf', x_index=x_einv_index, ylim=[40, 100], ylabel='[bEUR/y]', xlabel='Yearly emissions limit [MtC02-eq./y]', x_index_2=x_cost_index, fontsize=20)
