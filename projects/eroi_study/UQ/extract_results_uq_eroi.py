...
gwp_tot_max = 42700 # ktCO2/y -> constraint on the GWP_tot, 85400, 56900, 28500, 19000
...
if __name__ == '__main__':
    ...
    for sample_i in range(0, N_samples):
        ...
        res_list.append([fec_tot_val / einv, cost_val.sum()])
    df_res = pd.DataFrame(data=np.asarray(res_list), columns=['EROI', 'cost'], index=[i for i in range(0, N_samples+1)])
