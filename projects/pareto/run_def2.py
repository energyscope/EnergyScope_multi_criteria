...
if __name__ == '__main__':
    ...
    res_to_minimize = {'locals': ["WOOD", "WET_BIOMASS", "WASTE", "RES_WIND", "RES_SOLAR", "RES_HYDRO", "RES_GEO"],
                       'imports': ["AMMONIA", "AMMONIA_RE", "BIODIESEL", "BIOETHANOL", "COAL", "DIESEL", "ELECTRICITY",
                                   "GAS", "GAS_RE", "GASOLINE", "H2", "H2_RE", "LFO", "METHANOL", "METHANOL_RE"]}
    # Pairs (dev cost, dev einv)
    epsilon_tuples = [(0.01, 0.01), (0.01, 0.05), (0.01, 0.1), (0.05, 0.01), (0.05, 0.05), (0.05, 0.1), (0.1, 0.1), (0.1, 0.05), (0.1, 0.01)]
    epsilon_tuples = [(0.2, 0.2)]
    cost_epsilons_on_pareto = [0.0025, 0.005, 0.01, 0.025, 0.05, 0.075]
    # epsilons_tuples = []
    for run_name in ['imports', 'locals']:
