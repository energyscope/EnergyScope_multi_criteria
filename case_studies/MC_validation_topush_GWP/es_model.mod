...
#let cost_min := 39000;	# minima obtained with single criterion optimisations
#let gwp_min := 1000;
#let einv_min := 35000;
#let cost_max := 100000;	# maxima observed with single criterion optimisations
#let gwp_max := 100000;
#let einv_max :=150000
...
#--------------------------------------------------New_Einv-------------------------------------------------#
#test to help constrain and accelerate problem for GWP opti
...
# To change the weights or normalization factors, go to ESTD_main.run lines 101 -> 112
